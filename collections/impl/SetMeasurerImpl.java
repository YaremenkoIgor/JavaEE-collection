...
import goIT.javaEE.collections.interfaces.SetOperationsMeasureAble;

import java.util.*;

public class SetMeasurerImpl extends Measurer implements SetOperationsMeasureAble {

    private Set<Integer> set;
    private Iterator<Integer> iterator;

    public SetMeasurerImpl(Set<Integer> set) {
        this.set = set;
    }
