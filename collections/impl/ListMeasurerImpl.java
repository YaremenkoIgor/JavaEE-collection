...
import goIT.javaEE.collections.interfaces.ListOperationsMeasureAble;

import java.util.List;
import java.util.ListIterator;
import java.util.Map;

public class ListMeasurerImpl extends Measurer implements ListOperationsMeasureAble {

    private List<Integer> list;
    private ListIterator<Integer> iterator;

    public ListMeasurerImpl(List<Integer> list) {
        this.list = list;
    }
