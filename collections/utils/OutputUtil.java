package goIT.javaEE.collections.utils;
...
public class OutputUtil {
    ...
    public static final String FILE_NAME = "D:\\Programming\\Java\\java_examples\\it_center_go_it\\src\\main\\java\\goIT\\javaEE\\collections\\savedResults\\results.txt";
    ...
    private static String createHeader(int inputCollectionDataVolume) {
        ...
        String firstLine = String.format("%s%,d%s", "Efficiency measurements for collections of ",
                inputCollectionDataVolume, " items, ms" + new Date());
